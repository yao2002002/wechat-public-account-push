export const config = {
  ...
  USERS: [ohuG76erC_YZwkQ6ieIpsfej2NV4,ohuG76X7wEd-rhRGrlVLd8vAgxEk
    {
      ...
      id: "ohuG76X7wEd-rhRGrlVLd8vAgxEk",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "	VbrD5mJYEGuPyjT-QQA110fStPLElEo6J6kxjj7n28Y",
      // 所在省份
      province: "内蒙古",
      // 所在城市
      city: "通辽",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "许某娟", "year": "2002", "date": "09-11"},
        {"type": "节日", "name": "恋爱纪念日", "year": "2022", "date": "07-03"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "亲爱且可爱的男朋友", "year": "2002", "date": "05-10"},
  ...
  CALLBACK_USERS: [Yao-2002002
    {
      // 一般都填自己
      name: "自己",
      // 自己的微信id，扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "ohuG76erC_YZwkQ6ieIpsfej2NV4",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {"type": "*生日", "name": "许某娟", "year": "1996", "date": "09-09", isShowAge: true},
